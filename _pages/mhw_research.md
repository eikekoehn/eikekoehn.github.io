...
<figure style="width: 80%" class="align-center">
  <a href="/assets/images/mhw_concept_sketch.png" title="Sketch of the MHW definition following Hobday et al. (2016, 2018). Marine heatwaves (MHWs) and marine coldspells (MCS) are defined as instances where the temperature leaves the 'normal' variability range, defined by the 90th and 10th percentile of the seasonally varying temperature distribution." alt="Example of MHW definition">
